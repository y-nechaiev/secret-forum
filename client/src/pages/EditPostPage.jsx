...
function EditPostPage() {
  ...
  const submitHandler = () => {
    try {
      ...
      toast("Post has been successfully modified");
  ...
  return (
    <form className="w-1/3 mx-auto py-10" onSubmit={(e) => e.preventDefault()}>
      ...
      <label className="text-xs text-white opacity-70" htmlFor="Post title.">
        Post title:
        <input
          type="text"
          value={title}
      ...
      <label className="text-xs text-white opacity-70" htmlFor="Post text.">
        Post text:
        <textarea
